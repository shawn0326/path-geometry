...
import type { CubicBezierSegment2, Segment2 } from '../types';
...
/**
 * Operations for 2D cubic Bezier segments.
 * 中文：二维三次 Bezier segment 的操作集合。
 */
export const cubicBezier2 = {
  /**
   * Creates a 2D cubic Bezier segment and clones the input points.
   ...
   */
  create(p0: ReadonlyVec2 = vec2.create(), p1: ReadonlyVec2 = vec2.create(), p2: ReadonlyVec2 = vec2.create(), p3: ReadonlyVec2 = vec2.create()): CubicBezierSegment2 {
    return { type: 'cubic-bezier', p0: vec2.clone(p0), p1: vec2.clone(p1), p2: vec2.clone(p2), p3: vec2.clone(p3), arcLengthDivisions: 200, _needsUpdate: true };
  },
  /**
   ...
   */
  pointAt(out: vec2, segment: CubicBezierSegment2, t: number): vec2 {
   ...
   * @returns The out vector.
   */
  pointAtU(out: vec2, segment: CubicBezierSegment2, u: number): vec2 {
   ...
   * @returns The out vector.
   */
  tangentAt(out: vec2, segment: CubicBezierSegment2, t: number): vec2 {
   ...
   */
  getLength(segment: CubicBezierSegment2): number {
   ...
   */
  getLengths(segment: CubicBezierSegment2, divisions?: number): number[] {
   ...
   */
  getPoints(segment: CubicBezierSegment2, divisions?: number): vec2[] {
   ...
   */
  getSpacedPoints(segment: CubicBezierSegment2, divisions?: number): vec2[] {
   ...
   */
  mapUToT(segment: CubicBezierSegment2, u: number, distance?: number): number {
   ...
   */
  markDirty(segment: CubicBezierSegment2): void {
